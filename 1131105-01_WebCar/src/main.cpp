...
const char* htmlHomePage PROGMEM = R"HTMLHOMEPAGE(
  ...
  <html>
    ...
    <body>
      <h1 style="color: teal; text-align: center;">ESP32 Web ControlCar</h1>
      <h2 style="text-align: center"> WiFi Controller </h2>
      <table border="1" style="width: 400px; margin: auto; table-layout: fixed; text-align: center" CELLSPACING=10>
        <tr>
          <td></td>
